...
namespace {
  ...
  constexpr Score Islands[30] =
  { S( 2, 0), S( 3, 0), S( 0, 0), S( 1,-2), S( 4, 0), S( 2,-2), S(-4, 0), S( 3, 0),
    S( 3, 0), S(-1, 1), S( 2,-4), S(-7, 0), S(-3,-2), S(-1,-1), S( 0, 0), S(-3, 1),
    S( 1,-2), S( 3,-1), S(-1, 2), S( 0, 0), S(-4, 3), S(-0,-2), S(-1, 1), S(-1, 3),
    S(-2, 0), S( 4,-1), S(-1, 0), S( 0,-1), S( 3, 2), S(-4,-4) };

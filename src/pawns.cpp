...
namespace {
  ...
  constexpr Score PASQT[SQUARE_NB] = {
    ...
    S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
    S( 0, -3), S(-3,  4), S( 3,  6), S( 2,  3), S( 0,  0), S( 0,  0), S( 2,  2), S(-3, -3),
    S(-2,  1), S( 1,  0), S( 3,  2), S(-1,  1), S( 0,  0), S( 1,  0), S( 3, -7), S(-3,  0),
    S( 2, -1), S( 9,  5), S( 2,  0), S( 1,  0), S(-1,  4), S( 3,  8), S(-3,  1), S( 1, -3),
    S( 1, -5), S( 6,  5), S( 7,  2), S( 2, -2), S(-3,  1), S( 1,  1), S( 2,  5), S( 1, -5),
    S( 4,  2), S( 6, -2), S( 0,  0), S( 3, -6), S(-2, -1), S( 3, -7), S( 5,  4), S(-4, -2),
    S( 4, -1), S( 1,  0), S( 0,  4), S(-2, -6), S( 3, -2), S(-1, -6), S( 3,  0), S(-2, -3)
  };

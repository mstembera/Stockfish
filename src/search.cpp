         ...
         && !(Limits.depth && mainThread && rootDepth / ONE_PLY > Limits.depth))
  {
      ...
      if (    Limits.use_time_management()
          ...
          && !Threads.stopOnPonderhit)
          {
              ...
              if (Time.elapsed() > Time.optimum() * bestMoveInstability * improvingFactor * 0.2 / 580)
              {
              ...
              double shuffleFactor = (rootPos.game_ply() - mainThread->shufflePly > 10) ? 0.2 : 1.0;

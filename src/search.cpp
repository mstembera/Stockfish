...
namespace {
  ...
  Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode, bool allowNull);
        ...
        while ((move = mp.next_move()) != MOVE_NONE)
            if (move != excludedMove && pos.legal(move))
            {
                ...
                if (value >= probCutBeta)
                    value = -search<NonPV>(pos, ss+1, -probCutBeta, -probCutBeta+1, depth - 4, !cutNode, allowNull);
    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
      ...
      if (ss->ply < thisThread->rootDepth * 2)
      {
              ...
              &&  tte->depth() >= depth - 3)
          {
              ...
              value = search<NonPV>(pos, ss, singularBeta - 1, singularBeta, singularDepth, cutNode, allowNull);
              ...
              || (cutNode && (ss-1)->moveCount > 1)))
      {
          ...
          value = -search<NonPV>(pos, ss+1, -(alpha+1), -alpha, d, true, allowNull);
          ...
          if (value > alpha && d < newDepth)
          {
              ...
              if (newDepth > d)
                  value = -search<NonPV>(pos, ss+1, -(alpha+1), -alpha, newDepth, !cutNode, allowNull);
      ...
      {
               value = -search<NonPV>(pos, ss+1, -(alpha+1), -alpha, newDepth - (r > 4), !cutNode, allowNull);
      }
      ...
      if (PvNode && (moveCount == 1 || (value > alpha && (rootNode || value < beta))))
      {
          ...
          value = -search<PV>(pos, ss+1, -beta, -alpha,
                              std::min(maxNextDepth, newDepth), false, allowNull);
      }

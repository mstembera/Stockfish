...
void Thread::search() {
  ...
  Move bestMoveD9 = MOVE_NONE;
  Value secondScoreD9 = VALUE_NONE;
         ...
         && !(Limits.depth && mainThread && rootDepth > Limits.depth))
  {
      ...
      for (pvIdx = 0; pvIdx < multiPV && !Threads.stop; ++pvIdx)
      {
          ...
          {
              if (rootDepth == 9 && multiPV == 1)
              {
                  multiPV = 2;
              }
              else if (rootDepth == 10 && multiPV > 1)
              {                  
                  multiPV = multiPVBackup;
                  bestMoveD9 = rootMoves[0].pv[0];
                  secondScoreD9 = rootMoves[1].score;
              }
          }
          ...
          && !mainThread->stopOnPonderhit)
      {
          ...
          if (bestMoveD9 == rootMoves[0].pv[0])
          {
              int scoreDelta = std::max(std::min(rootMoves[0].score - secondScoreD9 - PawnValueEg, QueenValueEg), VALUE_ZERO);

...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  2,-11), S( -5, -4), S( 10,  5), S( 14, -4), S( 21,  5), S( 18,  5), S(  7, -2), S( -2,-20) },
   { S(-12, -6), S(-13, -6), S( 12, -1), S( 21, -2), S( 23, -2), S( 27,  2), S(  3, -3), S(-25, -4) },
   { S( -8,  2), S(-18, -7), S(  7, -7), S( 23, -9), S( 33, -9), S( 25,-15), S( -3, -7), S(-15, -8) },
   { S(  7, 18), S( -3,  3), S(-11,  2), S(  2,-10), S( 12,-13), S(  6, -8), S(-11, 10), S(  2, 10) },
   { S( -6, 25), S( -9, 17), S(  4, 19), S( 11, 28), S(-15, 29), S(  0,  8), S(-12,  3), S(-14, 13) },
   { S(-11,  0), S(  3, -4), S( -8, 19), S(-12, 22), S( -5, 22), S(-15, 19), S( 11,  2), S( -2, 11) }
  };

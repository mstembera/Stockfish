...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-27, 0), S(-18, 0), S(-10, 0), S( 1, 0) },
   { S(-23, 0), S(-10, 0), S(  3, 0), S(10, 0) },
   { S(-23, 0), S(-11, 0), S(  2, 0), S(12, 0) },
   { S(-24, 0), S( -8, 0), S(  5, 0), S(12, 0) },
   { S(-24, 0), S( -9, 0), S(  6, 0), S(11, 0) },
   { S(-23, 0), S( -9, 0), S(  6, 0), S(12, 0) },
   { S(-14, 0), S(  2, 0), S( 14, 0), S(22, 0) },
   { S(-25, 0), S(-17, 0), S( -5, 0), S( 5, 0) }
  },
  { // Queen

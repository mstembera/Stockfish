...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(272, -1), S(326, 41), S(273, 80), S(193, 93) },
   { S(275, 56), S(304, 98), S(240,138), S(183,131) },
   { S(198, 85), S(253,138), S(168,165), S(121,173) },
   { S(168,103), S(191,152), S(136,168), S(109,169) },
   { S(144, 97), S(176,166), S(112,197), S( 70,194) },
   { S(121, 87), S(159,164), S( 85,174), S( 37,189) },
   { S( 85, 39), S(119, 99), S( 63,128), S( 25,140) },
   { S( 64,  5), S( 87, 62), S( 49, 77), S(  1, 76) }
  }
};

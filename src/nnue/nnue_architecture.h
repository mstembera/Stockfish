...
struct Network {
    ...
    std::int32_t propagate(const TransformedFeatureType* transformedFeatures, int inputThreshold) {
        ...
        fc_0.propagate(transformedFeatures, buffer.fc_0_out, inputThreshold);

...
void find_nnz(const std::int32_t* input, std::uint16_t* out, IndexType& count_out, int inputThreshold) {
    ...
    using vec_t = __m256i;
                ...
                #define vec_nnz_threshold(a, b) \
                    _mm256_cmpgt_epi32_mask(_mm256_madd_epi16(_mm256_maddubs_epi16(a, a), _mm256_set1_epi16(1)), b)
            #else
                #define vec_nnz(a) \
                    _mm256_movemask_ps( \
                ...
                #define vec_nnz_threshold(a, b) \
                    _mm256_movemask_ps( \
                      _mm256_castsi256_ps(_mm256_cmpgt_epi32(_mm256_madd_epi16(_mm256_maddubs_epi16(a, a), _mm256_set1_epi16(1)), b)))
            #endif

...
namespace {
  ...
  // Assumes m2 >= m3
  inline void partial_order_em(ExtMove& m1, ExtMove& m2, ExtMove& m3)
  {
      bool b = m1.value < m3.value;
      ExtMove tmp = b ? m3 : m1;
      m3 = b ? m1 : m3;
      b = tmp.value <= m2.value;
      m1 = b ? m2 : m1;
      m2 = b ? tmp : m2;
  }
  ...
  void sort3(ExtMove* begin, const ExtMove*, int) {
      ...
      partial_order_em(begin[0], begin[1], begin[2]);
  }
...
top:
  ...
  case QCAPTURE_INIT:
      ...
      score<CAPTURES>();
      sort_moves(cur, endMoves, std::numeric_limits<int>::min());
      ++stage;
      goto top;
  ...
  case QUIET_INIT:
      if (!skipQuiets)
      {
          ...
          score<QUIETS>();
          sort_moves(cur, endMoves, -3000 * depth);
      }

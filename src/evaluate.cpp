...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    { S(-75,-73), S(-57,-54), S( -8,-27), S( -1, -8), S(  6,  7), S( 14, 12),  // Knights
      S( 22, 26), S( 29, 28), S( 36, 26) },
    { S(-48,-57), S(-20,-23), S( 16, -3), S( 26, 14), S( 38, 24), S( 51, 42),  // Bishops
      S( 55, 52), S( 62, 55), S( 63, 62), S( 68, 67), S( 81, 74), S( 81, 76),
      S( 91, 85), S( 98, 84) },
    { S(-58,-76), S(-26,-18), S(-13, 28), S( -9, 56), S( -5, 69), S( -2, 84),  // Rooks
      S(  9,112), S( 16,118), S( 29,132), S( 29,142), S( 32,154), S( 37,164),
      S( 46,165), S( 48,168), S( 58,170) },
    { S(-39,-36), S(-21,-15), S(  3,  8), S(  3, 18), S( 14, 34), S( 23, 54),  // Queens
      S( 29, 61), S( 41, 73), S( 43, 79), S( 48, 92), S( 56, 94), S( 60,104),

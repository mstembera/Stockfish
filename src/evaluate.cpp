...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    { S(-75,-73), S(-55,-53), S( -7,-27), S( -1, -8), S(  7,  7), S( 15, 13), // Knights
      S( 22, 26), S( 29, 28), S( 35, 28) },
    { S(-47,-56), S(-19,-22), S( 17, -2), S( 26, 14), S( 38, 25), S( 50, 42), // Bishops
      S( 54, 54), S( 62, 57), S( 62, 64), S( 67, 72), S( 81, 77), S( 81, 84),
      S( 91, 88), S( 98, 94) },
    { S(-58,-76), S(-25,-16), S(-13, 29), S( -9, 55), S( -5, 70), S( -1, 83), // Rooks
      S(  9,112), S( 16,118), S( 30,132), S( 29,141), S( 32,154), S( 37,164),
      S( 44,165), S( 48,168), S( 58,169) },
    { S(-39,-36), S(-21,-14), S(  5,  8), S(  3, 18), S( 16, 34), S( 24, 54), // Queens
      S( 30, 61), S( 42, 73), S( 43, 80), S( 48, 92), S( 56, 94), S( 60,104),
      S( 60,112), S( 65,119), S( 66,123), S( 69,126), S( 71,133), S( 73,136),
      S( 79,140), S( 88,143), S( 88,148), S( 99,166), S(102,170), S(102,174),

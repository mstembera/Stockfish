...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    { S(-74,-72), S(-56,-54), S( -9,-28), S( -2,-10), S(  6,  5), S( 14, 12), // Knights
      S( 22, 26), S( 29, 29), S( 36, 29)  },
    { S(-48,-57), S(-20,-23), S( 16, -3), S( 26, 13), S( 38, 24), S( 51, 42), // Bishops
      S( 55, 54), S( 63, 57), S( 63, 65), S( 68, 71), S( 81, 75), S( 81, 81),
      S( 91, 82), S( 98, 86) },
    { S(-58,-76), S(-26,-18), S(-14, 28), S(-10, 55), S( -5, 69), S( -2, 82), // Rooks
      S(  9,112), S( 16,118), S( 30,132), S( 29,142), S( 32,155), S( 38,165),
      S( 46,166), S( 48,169), S( 58,171) },
    { S(-26,-36), S(-20,-14), S(  3, 12), S(  5, 18), S( 15, 34), S( 23, 54), // Queens
      S( 29, 61), S( 41, 73), S( 43, 79), S( 48, 92), S( 56, 94), S( 60,104),
      S( 60,113), S( 66,120), S( 67,123), S( 70,126), S( 71,133), S( 73,136),
      S( 79,140), S( 88,143), S( 88,148), S( 99,166), S(102,170), S(102,174),
      S(106,182), S(108,189), S(112,205), S(116,209) }
  };

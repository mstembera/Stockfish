...
namespace {
  ...
  Value do_evaluate(const Position& pos) {
    ...
    Bitboard blockedPawns[] = {
      pos.pieces(WHITE, PAWN) & (shift_bb<DELTA_S>(pos.pieces(BLACK, PAWN)) | Rank2BB | Rank3BB),
      pos.pieces(BLACK, PAWN) & (shift_bb<DELTA_N>(pos.pieces(WHITE, PAWN)) | Rank7BB | Rank6BB)
    };

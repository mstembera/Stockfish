    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
            ...
            if (Pt == BISHOP)
            {
                ...
                knightKingDistance = std::min(knightKingDistance, distance(s, pos.square<KING>(Us)));

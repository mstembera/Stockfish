...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    { S(-75,-76), S(-57,-54), S( -8,-27), S( -1, -8), S(  7,  7), S( 14, 13), // Knights
      S( 22, 26), S( 29, 28), S( 36, 28) },
    { S(-48,-59), S(-20,-23), S( 16, -2), S( 26, 14), S( 38, 25), S( 50, 42), // Bishops
      S( 54, 54), S( 62, 57), S( 63, 64), S( 68, 72), S( 81, 77), S( 81, 84),
      S( 91, 88), S( 98, 97) },
    { S(-58,-76), S(-26,-18), S(-13, 28), S( -9, 55), S( -5, 69), S( -1, 83), // Rooks
      S(  9,112), S( 16,118), S( 30,132), S( 29,142), S( 32,154), S( 38,164),
      S( 46,165), S( 48,168), S( 58,169) },
    { S(-39,-36), S(-21,-15), S(  3,  8), S(  3, 18), S( 14, 34), S( 23, 54), // Queens
      S( 29, 61), S( 42, 73), S( 43, 79), S( 48, 92), S( 56, 94), S( 60,104),

        ...
        if (r > RANK_3)
        {
            ...
            if (pos.empty(blockSq))
            {
                ...
                if (pos.pieces(Them) & bb)
                    unsafeSquares = forward_ranks_bb(Us, s) & ((adjacent_files_bb(s) & attackedBy[Them][ALL_PIECES]) | file_bb(s));
                else
                    unsafeSquares = passed_pawn_span(Us, s) & attackedBy[Them][ALL_PIECES];

...
struct TTEntry {
  ...
  Bound bound() const      { return (Bound)(genProbedBound8 & 0x3); }
...
public:
 ~TranspositionTable() { free(mem); }
  void new_search() { generation += 8; } // Lowest 2 bits are used by Bound; 3rd bit for probed status
...
private:
  ...
  TTCluster* table;
  void* mem;
  uint8_t generation; // Size must be not bigger than TTEntry::genProbedBound8
};
